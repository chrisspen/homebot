...
class TorsoMotionClient(object):
    ...
    def __init__(self, **kwargs):
        ...
        rospy.init_node('torso_motion_client', log_level=rospy.DEBUG)
...
if __name__ == '__main__':
    ...
    parser.add_argument('distance', type=int, default=10, help='distance to move in mm')
    TorsoMotionClient(**parser.parse_args().__dict__)
