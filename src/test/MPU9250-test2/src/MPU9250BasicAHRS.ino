...
float magnetic_bearing_in_radians;
...
//  MadgwickQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f,  my,  mx, mz);
  MahonyQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f, my, mx, mz);
   ...
   //display.display();
    ...
    if(SerialDebug) {
    	magnetic_bearing_in_radians = atan2(my, mx) * 180/PI;
		...
		Serial.print(" mbearing = "); Serial.print((int)magnetic_bearing_in_radians); Serial.println(" deg");
